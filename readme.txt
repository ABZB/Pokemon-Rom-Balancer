...
Section II: Description of Edits
	...
	3) Pokemon that don't evolve:
		...
		b) Legendaries with a BST of less than 600, and all Pokemon that do not evolve (like Venasaur or Tauros), get a BST of 600, except for:
			i) Wishiwashi's School Forme is scaled to 700, its base Forme is left as is
			ii) Porygon2 and Scyther are scaled to 600
			iii) Shedinja is scaled to 400, then its HP is reset to 1
			iv) Regigas is scaled to 600, and gains the Abilities Iron Fist and Sheer Force
